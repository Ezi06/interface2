(function () {
    ...
    function component(object) {
      ...
      this.append = function (element) {
        ...
        // Store the movie/show title from element
        var movieTitle = element.title || element.name || element.original_title || element.original_name || '';
        ...
        // Add title overlay to the card
        setTimeout(function() {
          var cardElement = item.render();
          if (movieTitle && !cardElement.find('.card-title-overlay').length) {
            var titleOverlay = $('<div class="card-title-overlay">' + movieTitle + '</div>');
